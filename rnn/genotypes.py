...
DARTS_TUNHOU = Genotype(recurrent=[('tanh', 0), ('identity', 0), ('tanh', 1), ('identity', 1), ('tanh', 1), ('identity', 2), ('identity', 4), ('tanh', 1)], concat=range(1, 9))
DARTS_NEW = Genotype(recurrent=[('identity', 0), ('relu', 1), ('sigmoid', 0), ('identity', 2), ('identity', 1), ('tanh', 4), ('relu', 0), ('identity', 1)], concat=range(1, 9))
DARTS = DARTS_NEW
